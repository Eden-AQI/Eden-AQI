...
static const char kKeyChainUDIDAccessGroup[] = "com.eden.zhengzhouaqi";

@implementation SvUDIDTools

+ (NSString*)UDID
{
    NSString *udid = [DefaultsHandler searchDataForKey:DEVICENUMBER];
    ...
    if (!udid) {
        ...
        [DefaultsHandler editPairWithData:udid withKey:DEVICENUMBER];
