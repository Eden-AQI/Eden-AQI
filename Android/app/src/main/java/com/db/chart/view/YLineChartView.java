 ...
 */
public class YLineChartView extends ChartView {
	...
	public YLineChartView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//					drawSmoothLine(canvas, lineSet);
	 ...
	 * @return {@link YLineChartView} self-reference.
     */
    public YLineChartView setClickablePointRadius(@FloatRange(from=0.f) float radius){
