...
namespace Eden.Core.Infrastructure
{
    /// <summary>
    /// Provides access to the singleton instance of the Sxg engine.
    /// </summary>
    public class EngineContext
    {
        ...
        protected static IEngine CreateEngineInstance(EdenConfig config)
        {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("EdenConfig") as EdenConfig;
