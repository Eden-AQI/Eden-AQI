    ...
    var v = function (d, l) {
        ...
        y = q("btnResetSize"), p = q("ImagePreviewLoader"), E = q("previewLink"), D = q("previewImage"); return {
            title: d.lang.image["image" == l ? "title" : "titleButton"], minWidth: 420, minHeight: 360, onShow: function () {
                ...
                } else "image" == l ? this.imageElement = d.document.createElement("img") : (this.imageElement = d.document.createElement("input"), this.imageElement.setAttribute("type", "image")), this.imageElement.setAttribute("alt", ""); this.imageElement.setAttribute("alt", d.fullUrl); this.linkEditMode || (this.linkElement = d.document.createElement("a")); this.commitContent(1, this.imageElement);
                        ...
                        type: "hbox", widths: ["280px", "110px"], align: "right", children: [{
                            id: "txtUrl", type: "text", label: d.lang.common.url, required: !0, onChange: function () {
                                var a = this.getDialog(), b = this.getValue(); if (0 < b.length) {
                                    ...
                                    c = a.originalElement; a.preview && a.preview.removeStyle("display"); c.setCustomData("isReady", "false"); var d = CKEDITOR.document.getById(p); d && d.setStyle("display", ""); c.on("load", u, a); c.on("error", h, a); c.on("abort", h, a); c.setAttribute("src", splitImgSrc(b).s1); a.preview && (x.setAttribute("src", splitImgSrc(b).s1), a.preview.setAttribute("src", x.$.src), e(a))
                                ...
                                var vv = this.getValue();
                                if (vv && vv.indexOf("--")>0) {
                                    var ss = splitImgSrc(vv);
                                    this.ts = true;
                                    this.setValue(ss.s1);
                                    //$('#' + this.domId + " input").value = ss.s1;
                                    d.fullUrl = ss.s2;
                                }
                                1 == a && (this.getValue() || this.isChanged()) ? (b.data("cke-saved-src", this.getValue()), b.setAttribute("src", splitImgSrc(this.getValue()).s1)) : 8 == a && (b.setAttribute("src", ""), b.removeAttribute("src"))
...
function splitImgSrc(src) {
    var spliterIndex = src.indexOf("--");
    if (spliterIndex < 0)
        return {s1:src,s2:src};
    return { s1: src.substring(0, spliterIndex), s2: src.substring(spliterIndex + 2) }
}